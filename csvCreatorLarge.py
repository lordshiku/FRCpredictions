...
data_event = "worlds_train"
test = 0

with open("events_data_train.json", "r") as file:
    events_data = json.load(file)

with open("teams_data_train.json", "r") as file:
...
with open(f"{data_event}.csv", "w", newline="") as file:
