...
with open("events_data_train.json", "w") as file:
    json.dump(events_data_train, file, indent=4)

with open("teams_data_train.json", "w") as file:
    json.dump(teams_data_train, file, indent=4)


with open("events_data_test.json", "w") as file:
    json.dump(events_data_test, file, indent=4)

with open("teams_data_test.json", "w") as file:
